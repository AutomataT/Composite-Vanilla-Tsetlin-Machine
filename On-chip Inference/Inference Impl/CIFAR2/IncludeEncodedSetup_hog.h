...
struct IncludeEncodedSetup_hog {
    ...
    static constexpr int FEATURES = 1620;
    ...
    static constexpr int NUM_OF_INCLUDES = 4602;
    static constexpr const char* INCENC_TA_FILE = "CIFAR21620_REDRESS_IncEncTA_C2_CL200_T30.txt";
    static constexpr const char* INC_PER_CLASS_FILE = "CIFAR21620_REDRESS_Inc_per_class.txt";
