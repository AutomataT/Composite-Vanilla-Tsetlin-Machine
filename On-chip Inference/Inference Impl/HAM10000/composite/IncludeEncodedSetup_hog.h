...
struct IncludeEncodedSetup_hog {
    ...
    static constexpr int FEATURES = 8820;
    ...
    static constexpr int NUM_OF_INCLUDES = 1781;
    static constexpr const char* INCENC_TA_FILE = "HAM10008820_REDRESS_IncEncTA_C2_CL200_T10.txt";
    static constexpr const char* INC_PER_CLASS_FILE = "HAM10008820_REDRESS_Inc_per_class.txt";
