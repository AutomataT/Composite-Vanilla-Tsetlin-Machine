...
struct IncludeEncodedSetup_thresh {
    ...
    static constexpr int FEATURES = 16384;
    ...
    static constexpr int NUM_OF_INCLUDES = 1288;
    static constexpr const char* INCENC_TA_FILE = "HAM100016384_REDRESS_IncEncTA_C2_CL200_T10.txt";
    static constexpr const char* INC_PER_CLASS_FILE = "HAM100016384_REDRESS_Inc_per_class.txt";
