...
struct IncludeEncodedSetup_thresh {
    ...
    static constexpr int NUM_OF_INCLUDES = 29622;
    static constexpr const char* INCENC_TA_FILE = "FMNIST784_REDRESS_IncEncTA_C10_CL200_T20.txt";
    static constexpr const char* INC_PER_CLASS_FILE = "FMNIST784_REDRESS_Inc_per_class.txt";
