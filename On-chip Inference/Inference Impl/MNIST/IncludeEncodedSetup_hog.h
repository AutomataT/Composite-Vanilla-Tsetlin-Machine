...
struct IncludeEncodedSetup {
    ...
    static constexpr int FEATURES = 479;
    ...
    static constexpr int NUM_OF_INCLUDES = 16748;
    static constexpr const char* INCENC_TA_FILE = "MNIST479_REDRESS_IncEncTA_C10_CL200_T10.txt";
    static constexpr const char* INC_PER_CLASS_FILE = "MNIST479_REDRESS_Inc_per_class.txt";
