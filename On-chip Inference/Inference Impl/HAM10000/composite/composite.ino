...
#define TEST_LENGTH_PER32 IncludeEncodedSetup_hog::TEST_LENGTH_PER32
#define CLASSES IncludeEncodedSetup_hog::CLASSES
#define NUMBER_OF_TEST_EXAMPLES IncludeEncodedSetup_hog::NUMBER_OF_TEST_EXAMPLES
#define CLAUSE_POLARITY_BIT IncludeEncodedSetup_hog::CLAUSE_POLARITY_BIT
#define BIT_DEMARCATING_CLAUSE_CHANGE IncludeEncodedSetup_hog::BIT_DEMARCATING_CLAUSE_CHANGE
#define INT_VALUE_OF_ENCODING_BITS IncludeEncodedSetup_hog::INT_VALUE_OF_ENCODING_BITS
