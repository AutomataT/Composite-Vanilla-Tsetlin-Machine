...
struct IncludeEncodedSetup_3x3 {
    ...
    static constexpr int FEATURES = 1815;
    ...
    static constexpr int NUM_OF_INCLUDES = 7604;
    static constexpr const char* INCENC_TA_FILE = "CIFAR21815_REDRESS_IncEncTA_C2_CL200_T30.txt";
    static constexpr const char* INC_PER_CLASS_FILE = "CIFAR21815_REDRESS_Inc_per_class.txt";
