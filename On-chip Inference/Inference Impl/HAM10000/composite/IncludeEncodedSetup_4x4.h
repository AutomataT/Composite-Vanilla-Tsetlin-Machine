...
struct IncludeEncodedSetup_4x4 {
    ...
    static constexpr int FEATURES = 3840;
    ...
    static constexpr int NUM_OF_INCLUDES = 1605;
    static constexpr const char* INCENC_TA_FILE = "HAM10003840_REDRESS_IncEncTA_C2_CL200_T10.txt";
    static constexpr const char* INC_PER_CLASS_FILE = "HAM10003840_REDRESS_Inc_per_class.txt";
